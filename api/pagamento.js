...
mercadopago.configure({
    access_token: process.env.MP_ACCESS_TOKEN // Lê a chave configurada de forma segura na Vercel
});

module.exports = async (req, res) => {
    // Permite que a sua aplicação no GitHub Pages faça requisições para a API
